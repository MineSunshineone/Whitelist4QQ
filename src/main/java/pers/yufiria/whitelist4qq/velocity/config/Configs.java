...
public class Configs {
    ...
    public static final StringConfig messagesBotMessageSelectPlayerFailedUnknownPlayer = new StringConfig("messages.bot_message.select_player_failed_unknown_player", "查询失败, 该玩家可能未进入过服务器");
